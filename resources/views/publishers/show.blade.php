...
<body>
    <div class="container mt-4">
        ...
        <h3>Reviews</h3>
        @if($publisher->reviews->isEmpty())
            <p>No reviews yet. Be the first to review this publisher!</p>
        @else
            @foreach($publisher->reviews as $review)
                <div class="card mb-3">
                    <div class="card-body">
        ...
        <form action="{{ route('addReview', ['type' => 'publisher', 'id' => $publisher->id]) }}" method="POST" class="mt-3">
            @csrf
            <div class="mb-3">
