        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex-shrink-0">
                    <a href="/" class="text-xl font-bold text-blue-500 whitespace-nowrap">Library Management</a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-blue-500 hover:underline whitespace-nowrap">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="text-blue-500 hover:underline whitespace-nowrap">Log in</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="text-blue-500 hover:underline whitespace-nowrap">Register</a>
                            @endif
                        @endauth
                    @endif
                </div>
    ...
    <main>
        ...
        <header class="bg-blue-500 py-20">
            <div class="max-w-7xl mx-auto px-4 text-center">
                ...
                <a href="{{ route('books.public') }}" class="mt-6 inline-block bg-white text-blue-500 font-bold py-2 px-4 rounded shadow hover:bg-gray-200">
                    Browse Books
                </a>
            </div>
        </header>
